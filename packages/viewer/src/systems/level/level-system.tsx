...
export const LevelSystem = () => {
  useFrame((_, delta) => {
    ...
    // Walk sorted levels, accumulating base Y offsets. Empty levels contribute
    // 0 height (see getLevelHeight) so they collapse without leaving phantom
    // gaps between authored floors.
    let cumulativeY = 0
